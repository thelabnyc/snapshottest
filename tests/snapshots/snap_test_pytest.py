...
snapshots['test_pytest_snapshottest_property_test_name_parametrize_multiline[ multi line string ] 1'] = 'counter'

snapshots['test_pytest_snapshottest_property_test_name_parametrize_singleline[single line string] 1'] = 'counter'
